...
public class FinancialStatements2 extends JFrame {
	...
	public FinancialStatements2() {
		...
		l_positionname = new JLabel("¼ÕÀÍ°è»ê¼­", SwingConstants.LEFT);
		l_positionname.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
