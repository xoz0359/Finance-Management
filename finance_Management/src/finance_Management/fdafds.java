...
public class fdafds extends JFrame {
   ...
   public void openUserRegistrationDialog() {
      userDialog = new JDialog(this, "»ç¿ëÀÚ µî·Ï", true);
   ...
   public void openCodeRegistrationDialog() {
      codeDialog = new JDialog(this, "°èÁ¤ÄÚµå µî·Ï", true);
   ...
   public void openAdminModeDialog() {

      adminDialog = new JDialog(this, "°èÁ¤ÄÚµå µî·Ï", true);
