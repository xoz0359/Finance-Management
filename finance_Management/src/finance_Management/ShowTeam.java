...
public class ShowTeam extends JPanel {
	...
	public ShowTeam() {
		...
		l_titlename = new JLabel("∫Œº≠¡§∫∏ ¡∂»∏", SwingConstants.CENTER);
		l_titlename.setFont(new Font("∏º¿∫ ∞ÌµÒ",Font.BOLD,20));
        ...
        tableHeader.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.BOLD, 13));
